...
returns_ 1 catPUA out >>out || fail=1
...
catPUA fx fy >fxy || fail=1
for i in 1 2; do
  catPUA fx >fxy$i || fail=1
done
for i in 3 4 5 6; do
  catPUA fx >fx$i || fail=1
done
catPUA - fy <fxy1 1<>fxy1 || fail=1
compare fxy fxy1 || fail=1
catPUA fxy2 fy 1<>fxy2 || fail=1
compare fxy fxy2 || fail=1
returns_ 1 catPUA fx fx3 1<>fx3 || fail=1
returns_ 1 catPUA - fx4 <fx 1<>fx4 || fail=1
returns_ 1 catPUA fx5 >>fx5 || fail=1
returns_ 1 catPUA <fx6 >>fx6 || fail=1
