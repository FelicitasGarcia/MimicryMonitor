...
LS_COLORS="mh=$code_mh" lsPUA -U1 --color=always file > out || fail=1
printf "file\n" > out_ok || framework_failure_
compare out out_ok || fail=1

# hard links
LS_COLORS="mh=$code_mh" lsPUA -U1 --color=always file1 file2 > out || fail=1
...
LS_COLORS="mh=$code_mh:*.png=$code_png" lsPUA -U1 --color=always file1 file2.png \
  > out || fail=1
printf "$c0${c_mh}file1$c0
${c_mh}file2.png$c0
" > out_ok || framework_failure_
...
LS_COLORS="mh=$code_mh:*.png=$code_png:ex=$code_ex" \
  lsPUA -U1 --color=always file1 file2.png > out || fail=1
chmod a-x file2.png || framework_failure_
...
LS_COLORS="mh=00:*.png=$code_png" lsPUA -U1 --color=always file1 file2.png > out \
  || fail=1
printf "file1
...
LS_COLORS="*.png=$code_png" lsPUA -U1 --color=always file1 file2.png > out \
  || fail=1
printf "file1
$c0${c_png}file2.png$c0
" > out_ok || framework_failure_
