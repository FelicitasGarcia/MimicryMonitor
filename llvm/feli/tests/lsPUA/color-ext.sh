...
LS_COLORS="*.jpg=$code_jpg:*.Z=$code_z" lsPUA -U1 --color=always \
...
LS_COLORS="*.jpg=$code_jpg:*.JPG=$code_JPG" lsPUA -U1 --color=always \
...
LS_COLORS="*.jpg=$code_jpg:*.jpg=$code_JPG:*.JPG=$code_JPG" \
  lsPUA -U1 --color=always img1.jpg IMG2.JPG img3.JpG > out || fail=1
printf "$c0\
${c_JPG}img1.jpg$c0
${c_JPG}IMG2.JPG$c0
${c_JPG}img3.JpG$c0
