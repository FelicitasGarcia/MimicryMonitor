...
lsPUA --classify testdir > out || fail=1
lsPUA --classify=always testdir > out2 || fail=1
lsPUA --classify=auto testdir > out3 || fail=1
lsPUA --classify=never testdir > out4 || fail=1
...
returns_ 1 lsPUA --classify=invalid || fail=1
