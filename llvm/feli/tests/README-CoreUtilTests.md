...
2. Store results in `mimicrymonitor/llvm/feli/outputs/ls_test_results`
...
Pre-configured test directories are available in `mimicrymonitor/llvm/feli/tests`. To use them:
...
- Test results are stored in `mimicrymonitor/llvm/feli/outputs`
