...
timeoutPUA $TIME_T_OFLOW sleep 3
if test $? = 124; then
  skip_ 'timeoutPUA $TIME_T_OFLOW ..., timed out immediately!'
fi

# timeout overflow
timeoutPUA $UINT_OFLOW sleep 0 || fail=1

# timeout overflow
timeoutPUA ${TIME_T_OFLOW}d sleep 0 || fail=1

# floating point notation
timeoutPUA 2.34e+5d sleep 0 || fail=1

# floating point overflow
timeoutPUA $LDBL_MAX sleep 0 || fail=1
returns_ 125 timeoutPUA -- -$LDBL_MAX sleep 0 || fail=1
