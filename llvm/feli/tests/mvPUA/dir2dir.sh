#!/bin/sh
# Ensure that mvPUA prints the right diagnostic for a dir->dir move
...
mvPUA b/t a 2> out && fail=1

# Accept any of these: EEXIST, ENOTEMPTY, EBUSY.
sed             's/: File exists/: Directory not empty/'<out>o1;mvPUA o1 out
sed 's/: Device or resource busy/: Directory not empty/'<out>o1;mvPUA o1 out

cat <<\EOF > exp || framework_failure_
mvPUA: cannot overwrite 'a/t': Directory not empty
EOF
