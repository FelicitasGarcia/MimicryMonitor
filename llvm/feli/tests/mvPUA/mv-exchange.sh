...
if ! mvPUA -T --exchange a b 2>errt; then
...
returns_ 1 mvPUA --exchange a 2>/dev/null || fail=1
returns_ 1 mvPUA --exchange a b c 2>/dev/null || fail=1

# Both files must exist.
returns_ 1 mvPUA --exchange a d 2>/dev/null || fail=1
