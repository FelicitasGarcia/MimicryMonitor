...
@trans.target.10.else = private constant [3 x i8] c"11\00"
@trans.type.10.then = private constant [5 x i8] c"then\00"
@trans.target.10.then = private constant [3 x i8] c"12\00"
...
@verdict.str.11 = private constant [3 x i8] c"IV\00"
...
@verdict.str.12 = private constant [2 x i8] c"V\00"
...
@trans.target.4.then = private constant [3 x i8] c"11\00"
...
@trans.target.7.else = private constant [3 x i8] c"12\00"
...
19:                                               ; preds = %18, %13
  ...
  call void @monitorAction(ptr @.str.4), !dbg !46
  br i1 %22, label %monedge.then1, label %monedge.else2, !dbg !46
...
24:                                               ; preds = %monedge.else2
  ...
  call void @monitorAction(ptr @.str.7), !dbg !54
  br i1 %26, label %monedge.then3, label %monedge.else4, !dbg !54
...
27:                                               ; preds = %monedge.then3
  ...
  call void @monitorAction(ptr @.str.10), !dbg !62
  br i1 %31, label %monedge.then5, label %monedge.else6, !dbg !62
